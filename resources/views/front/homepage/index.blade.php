...
<div class="preloader">
    ...
    <h6 class="preloader-text">Hospital<br>Template</h6>
</div>
<!-- End of .preloader -->
...
<div class="page">
    ...
    <header class="header-middle header-middle_white-transparent">
        <div class="container">
            ...
            @include('front.homepage.layouts.partials.navbar-logo')
                            ...
                            <div class="services__item-icon">
                                <svg width="50" height="38.03" viewBox="0 0 50 38.03">
                                    <path id="service-icon4.svg" class="cls-2"
                                          ...
                                          transform="translate(-2689 -1304.97)"/>
                                </svg>
                            </div>
