            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="title m-l-5"><a
                            class="btn mr-1 mb-3 btn-primary btn-sm " href="{{route('employees.create')}}">Employees
                            add</a>
                    </div>
                            ...
                            @if(isset($employeess))
                                @foreach($employeess as $key => $employees)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('employ.edit', $employees)}}"
                                               class="btn btn-primary">Edit</a>
                                            <form class="d-inline"
                                                  action="{{route('employ.destroy', $employees->id)}}"
                                                  method="post">
                                                @csrf
                                                @method('DELETE')
